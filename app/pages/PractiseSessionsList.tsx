    ...
    <div className="p-6">
      ...
      {sessions.length === 0 ? (
        <div className="text-center py-12 bg-gray-50 rounded-lg">
          ...
          <h3 className="mt-2 text-sm font-medium text-gray-900">No practice sessions yet</h3>
          <p className="mt-1 text-sm text-gray-500">Get started by creating your first practice session.</p>
          <div className="mt-6">
            <Link
              to="/practise-sessions/new"
              ...
              <div className="flex justify-between items-start">
                ...
                <div className="flex flex-col items-end ml-4 flex-shrink-0 gap-2">
                  ...
                  <div className="flex items-center text-sm text-gray-500">
                    ...
                    {session._count.sectionItems} {session._count.sectionItems === 1 ? 'item' : 'items'}
                  </div>
                </div>
              </div>
            </Link>
